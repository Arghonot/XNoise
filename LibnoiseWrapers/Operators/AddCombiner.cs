...
namespace XNoise
{
    public class AddCombiner : LibNoise.Operator.Add, INoiseStrategy
    {
        public AddCombiner(ModuleBase lhs, ModuleBase rhs) : base(lhs, rhs) { }
        ...
        {
            var materialGPU = XNoiseShaderCache.GetMaterial(XNoiseShaderPaths.Add);
