...
namespace XNoise
{
    public class MaxCombiner : LibNoise.Operator.Max, INoiseStrategy
    {
        public MaxCombiner(ModuleBase lhs, ModuleBase rhs) : base(lhs, rhs) { }
        ...
        {
            var materialGPU = XNoiseShaderCache.GetMaterial(XNoiseShaderPaths.Max);
