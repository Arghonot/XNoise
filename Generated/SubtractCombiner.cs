...
namespace XNoise
{
    public class SubtractCombiner : LibNoise.Operator.Subtract, INoiseStrategy
    {
        public SubtractCombiner(ModuleBase lhs, ModuleBase rhs) : base(lhs, rhs) { }
        ...
        {
            var materialGPU = XNoiseShaderCache.GetMaterial(XNoiseShaderPaths.Subtract);
